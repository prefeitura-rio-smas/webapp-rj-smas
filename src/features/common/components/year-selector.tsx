  ...
  return (
    <div className="relative inline-block text-left w-full max-w-md mx-auto mb-4 md:mb-6">
      <button
        ...
        className="w-full flex items-center justify-between bg-white dark:bg-[#1a3b6d] text-[#0d2953] dark:text-white p-3 md:p-4 rounded-md border border-[#c1cee3] dark:border-[#1a3b6d] shadow-sm"
      >
          ...
          <div className="py-1">
            {years.map((year) => (
              <button
                ...
                className={`w-full text-left px-3 md:px-4 py-2 md:py-3 text-sm md:text-base text-[#0d2953] dark:text-white hover:bg-[#e0e7f2] dark:hover:bg-[#1a3b6d] ${
                  year === currentYear ? "font-medium bg-[#e0e7f2] dark:bg-[#1a3b6d]" : ""
                }`}
              >
